  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center px-4">
        <HiVideoCamera className="text-6xl text-base-content/30" />
        <h2 className="text-2xl font-bold">Login to manage your videos</h2>
        <p className="text-base-content/60 max-w-md">
          You need to be logged in to upload, organize, and manage your video
          collection.
        </p>
